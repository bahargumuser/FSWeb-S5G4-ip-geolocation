...
var cardYapici = function cardYapici(item) {
  var ülke = item.ülke,
    parabirimi = item.parabirimi,
    saatdilimi = item.saatdilimi,
    isp = item.isp,
    şehir = item.şehir,
    enlem = item.enlem,
    boylam = item.boylam,
    sorgu = item.sorgu,
    ülkeKodu = item.ülkeKodu,
    ülkebayrağı = item.ülkebayrağı;
  ...
  var cardp7 = document.createElement("p");
  cardp7.classList = "ulke";
  cardp7.textContent = "".concat(ülke, "(").concat(ülkeKodu, ")");
  divAdd1.appendChild(cardp7);
  var cardp1 = document.createElement("p");
  cardp1.textContent = "Enlem: ".concat(enlem, " Boylam: ").concat(boylam);
  divAdd1.appendChild(cardp1);
  var cardp2 = document.createElement("p");
  cardp2.textContent = "\u015Eehir: ".concat(şehir);
  divAdd1.appendChild(cardp2);
  var cardp4 = document.createElement("p");
  cardp4.textContent = "Saat dilimi: ".concat(saatdilimi);
  divAdd1.appendChild(cardp4);
  var card5 = document.createElement("p");
  card5.textContent = "Para birimi: ".concat(parabirimi);
  divAdd1.appendChild(card5);
  var card6 = document.createElement("p");
  card6.textContent = "ISP: ".concat(isp);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _context.next = 4;
          return _axios.default.get("https://apis.ergineer.com/ipgeoapi/" + benimIP).then(function (response) {
